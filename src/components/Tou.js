      ...
      <div className="container">
        ...
        <div>
          <p className="pt-4 pb-16">
            Terms and Conditions Agreement between User, poplme.co and popl.co
          </p>
          <p className="mb-10">
            Welcome to poplme.co. The poplme.co website (the "Site") is
            comprised of various web pages operated by Popl Co ("Popl").
            poplme.co is offered to you conditioned on your acceptance without
            modification of the terms, conditions, and notices contained herein
            (the "Terms"). Your use of poplme.co constitutes your agreement to
            all such Terms. Please read these terms carefully, and keep a copy
            of them for your reference. poplme.co is a Social Networking Site.
            This website will hold public user profiles that are shared with
            others in a social media fashion. Users will be able to search for
            profiles by name. Nothing on this website is for sale at the moment.
            Privacy Your use of poplme.co is subject to Popl's Privacy Policy.
            Please review our Privacy Policy, which also governs the Site and
            informs users of our data collection practices. Electronic
            Communications Visiting poplme.co or sending emails to Popl
          ...
          <p className="mb-10">
            ...
            entity. You acknowledge that Popl is not responsible for third party
            access to your account that results from theft or misappropriation
            of your account. Popl and its associates reserve the right to refuse
            or cancel service, terminate accounts, or remove or edit content in
            our sole discretion. Children Under Thirteen Popl does not knowingly
            ...
            poplme.co only with permission of a parent or guardian. Links to
            Third Party Sites/Third Party Services poplme.co may contain links
            to other websites ("Linked Sites"). The Linked Sites are not under
            the control of Popl and Popl is not responsible for the contents of
            any Linked Site, including without limitation any link contained in
            a Linked Site, or any changes or updates to a Linked Site. Popl is
            providing these links to you only as a convenience, and the
            inclusion of any link does not imply endorsement by Popl of the site
            or any association with its operators. Certain services made
            available via poplme.co are delivered by third party sites and
            organizations. By using any product, service or functionality
            originating from the poplme.co domain, you hereby acknowledge and
            consent that Popl may share such information and data with any third
            party with whom Popl has a contractual relationship to provide the
            requested product, service or functionality on behalf of poplme.co
            users and customers. No Unlawful or Prohibited Use/Intellectual
            Property You are granted a non-exclusive, non-transferable,
            revocable license to access and use poplme.co strictly in accordance
            with these terms of use. As a condition of your use of the Site, you
            warrant to Popl that you will not use the Site for any purpose that
            ...
            property of Popl or its suppliers and protected by copyright and
            ...
            of the content, in whole or in part, found on the Site. Popl content
            ...
            the express written permission of Popl and the copyright owner. You
            ...
            the intellectual property of Popl or our licensors except as
            expressly authorized by these Terms.
          </p>
          <p className="mb-10">
            Third Party Accounts You will be able to connect your Popl account
            to third party accounts. By connecting your Popl account to your
            ...
            Service is controlled, operated and administered by Popl from our
            ...
            laws. You agree that you will not use the Popl Content accessed
            through poplme.co in any country or in any manner prohibited by any
            applicable laws, restrictions or regulations. Indemnification You
            agree to indemnify, defend and hold harmless Popl, its officers,
            ...
            regulations. Popl reserves the right, at its own cost, to assume the
            exclusive defense and control of any matter otherwise subject to
            indemnification by you, in which event you will fully cooperate with
            Popl in asserting any available defenses. Arbitration In the event
            the parties are not able to resolve any dispute between them arising
            ...
            only by final and binding arbitration pursuant to the Federal
          ...
          <p className="mb-10">
            ...
            AGAINST THE OTHER. Further, unless both you and Popl agree
            ...
            POPL CO AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR CHANGES IN
            THE SITE AT ANY TIME. POPL CO AND/OR ITS SUPPLIERS MAKE NO
            ...
            PROVIDED "AS IS" WITHOUT WARRANTY OR CONDITION OF ANY KIND. POPL CO
            ...
            IN NO EVENT SHALL POPL CO AND/OR ITS SUPPLIERS BE LIABLE FOR ANY
            ...
            EVEN IF POPL CO OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF THE
          ...
          <p className="mb-10">
            Termination/Access Restriction Popl reserves the right, in its sole
            ...
            laws of the State of California and you hereby consent to the
            ...
            and Popl as a result of this agreement or use of the Site. Popl's
            ...
            Popl's right to comply with governmental, court and law enforcement
            requests or requirements relating to your use of the Site or
            information provided to or gathered by Popl with respect to such
            ...
            user and Popl with respect to the Site and it supersedes all prior
            or contemporaneous communications and proposals, whether electronic,
            oral or written, between the user and Popl with respect to the Site.
            ...
            all related documents be written in English. Changes to Terms Popl
            reserves the right, in its sole discretion, to change the Terms
            under which poplme.co is offered. The most current version of the
            Terms will supersede all previous versions. Popl encourages you to
            periodically review the Terms to stay informed of our updates.
          </p>
          <p className="mb-8">
            Popl welcomes your questions or comments regarding the Terms:
          </p>
          <p className="mb-8">
            Popl Co PO Box 25667 Los Angeles, CA 90025 Email Address:
            legal@popl.co Telephone number: 15108478748 Effective as of
            September 16, 2019
          </p>
          <p className="text-center mb-10">Popl 🤍</p>
        </div>
      </div>
      <Footer />
    </>
